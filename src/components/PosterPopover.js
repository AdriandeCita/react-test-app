...
class PosterPopover extends Component {
    ...
    render() {
        return (
            <div className={`popover popover-poster ${this.props.visible ? 'visible': ''}`}>
                ...
                <form action="#" className="form" onSubmit={this.handleSubmit}>
                    <input type="text" placeholder="Enter URL poster" className="text-input" value={this.state.src} onChange={this.handleChange}/>
